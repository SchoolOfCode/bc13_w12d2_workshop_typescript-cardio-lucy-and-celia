...
1. Declare and initialise variables (names and values of your variables are up to you) for each of the following types:
...
4. Declare a new type which is any one of: "BLUE" or "YELLOW" (hint: https://www.typescriptlang.org/docs/handbook/2/everyday-types.html#union-types).
...
Optional bonus/stretch task:

TypeScript offers something called enums.

1.  Explore what enums are (find some user friendly resources/videos).
2.  Optionally rework the choices (rock, paper, scissors) and outcomes (win, loss, draw) to use enums.
